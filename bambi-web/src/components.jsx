...
import { IconStar, IconX, IconCheck, IconChevL, IconChevR } from './icons.jsx';
...
// =========== Star rating ===========
export function StarRating({ value = 0, max = 5, size = 18, onChange, readOnly = false }) {
  return (
...
export function PageWrap({ children, narrow, wide }) {
